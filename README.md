...
Bash
javac -d classes src/com/pizzariachief/pedidos/application/Main.java src/com/pizzariachief/pedidos/model/*.java src/com/pizzariachief/pedidos/model/decorators/*.java
Execute a aplicação:
Bash
java -cp classes com.pizzariachief.pedidos.application.Main
